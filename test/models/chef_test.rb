...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "join", email: "john@example.com")
  end 
  ...
  test "chefname name should not be too short" do
    @chef.chefname = "aa"
    assert_not @chef.valid?
  end
  ...
  test "reject invalid email" do
    invalid_addresses = %w[user@example,com user_at_eee.org user.name@exmaple. eee@i_am_.com foo@ee+aar.com]
